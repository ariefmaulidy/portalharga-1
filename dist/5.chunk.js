webpackJsonpac__name_([5],Array(493).concat([
/* 493 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__infoHarga_routing__ = __webpack_require__(770);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__infoHarga_component__ = __webpack_require__(735);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_tables_tables_component__ = __webpack_require__(734);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InfoHargaModule", function() { return InfoHargaModule; });
...
var InfoHargaModule = (function () {
    function InfoHargaModule() {
    }
    InfoHargaModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                __WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"],
                __WEBPACK_IMPORTED_MODULE_2__angular_forms__["FormsModule"],
                __WEBPACK_IMPORTED_MODULE_3__theme_nga_module__["a" /* NgaModule */],
                __WEBPACK_IMPORTED_MODULE_6__infoHarga_routing__["a" /* routing */],
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_7__infoHarga_component__["a" /* InfoHarga */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_style_loader_tables_scss__ = __webpack_require__(831);
...
var Tables = (function () {
    function Tables(authHttp, data) {
        ...
        if (localStorage.getItem('infoHarga')) {
            this.source.load(JSON.parse(localStorage.getItem('infoHarga')));
        }
        //get data from database
        this.getLaporanHargaFunction();
    }
    Tables.prototype.getLaporanHargaFunction = function () {
        var _this = this;
    ...
    Tables.prototype.updateLaporanHargaFunction = function (data) {
        var _this = this;
    ...
    Tables.prototype.addLaporanHargaFunction = function () {
        var _this = this;
        ...
        this.authHttp.post(this.data.urlAddLaporanHarga, creds)
            ...
            localStorage.setItem('id_token', data.token);
            _this.data.showMessage(data.message);
            _this.getLaporanHargaFunction();
        });
        this.clearForm();
    };
    Tables.prototype.deleteLaporanHargaFunction = function () {
        var _this = this;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(2);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return InfoHarga; });

var InfoHarga = (function () {
    function InfoHarga() {
    }
    InfoHarga.prototype.ngOnInit = function () {
    };
    InfoHarga = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'infoHarga',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__infoHarga_component__ = __webpack_require__(735);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_tables_tables_component__ = __webpack_require__(734);
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_1__infoHarga_component__["a" /* InfoHarga */],
        children: [
