...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__dashboard_component__ = __webpack_require__(731);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__dashboard_routing__ = __webpack_require__(764);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pieChart__ = __webpack_require__(768);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__feed__ = __webpack_require__(766);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__feed_feed_service__ = __webpack_require__(732);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pieChart_pieChart_service__ = __webpack_require__(733);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__map_map_component__ = __webpack_require__(767);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_ng2_bootstrap__ = __webpack_require__(683);
        ...
        this._data = [
            {
                type: 'text-message',
                author: '',
                surname: 'Irfan Rafii Musyafa',
                harga: 'Rp. 30.000/Kg',
                komoditas: 'Cabai',
                header: 'Posted new message',
                text: 'Jl. Bungur Kemang Jaksel No.1, Babakan, Dramaga, Bogor, Jawa Barat 16680, Indonesia',
                time: 'Thursday, June 8, 2017',
                ago: '',
                expanded: false,
            }, {
                type: 'text-message',
                author: '',
                surname: 'Ryan Baskaraa',
                harga: 'Rp. 24.500/Kg',
                komoditas: 'Cabai',
                header: 'Posted new message',
                text: 'Jl. Babakan Raya No.111, Babakan, Dramaga, Bogor, Jawa Barat 16680, Indonesia',
                time: 'Thursday, June 8, 2017',
                ago: '',
                expanded: false,
            }, {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dashboard_component__ = __webpack_require__(731);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__feed_service__ = __webpack_require__(732);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_jwt__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_jwt___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_angular2_jwt__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__data_data_service__ = __webpack_require__(549);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_style_loader_feed_scss__ = __webpack_require__(829);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_style_loader_feed_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_style_loader_feed_scss__);
...
var Feed = (function () {
    function Feed(_feedService, authHttp, data) {
        var _this = this;
        ...
        this.interval = setInterval(function () {
            if (localStorage.getItem('feed')) {
                _this.getFeedFunction();
            }
        }, 2000);
    }
    Feed.prototype.formatDate = function (x) {
        var options = { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' };
        var d = new Date(x);
        return d.toLocaleDateString("en-US", options);
    };
    Feed.prototype.numberWithCommas = function (x) {
        var parts = x.toString().split(".");
        parts[0] = parts[0].replace(/\B(?=(\d{3})+(?!\d))/g, ".");
        return parts.join(".");
    };
    Feed.prototype.getFeedFunction = function () {
    ...
    Feed = __decorate([
        ...
        __metadata('design:paramtypes', [__WEBPACK_IMPORTED_MODULE_1__feed_service__["a" /* FeedService */], __WEBPACK_IMPORTED_MODULE_2_angular2_jwt__["AuthHttp"], __WEBPACK_IMPORTED_MODULE_3__data_data_service__["a" /* DataService */]])
    ], Feed);
    return Feed;
}());
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__feed_component__ = __webpack_require__(765);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_google_maps__ = __webpack_require__(777);
...
var Maps = (function () {
    function Maps(_elementRef, authHttp, data) {
        ...
        this.authHttp = authHttp;
        this.data = data;
        this.selectKomoditas = 'Seluruh Komoditas';
        this.markers = [];
        this.day = 99;
    ...
    // layout function
    Maps.prototype.ngOnDestroy = function () {
        if (this.interval) {
    ...
    //interface function
    Maps.prototype.setType = function (type) {
        this.type = type;
        if (type == 'infoHarga') {
    ...
    Maps.prototype.expandMessage = function (message) {
        message.expanded = !message.expanded;
    };
    Maps.prototype.setDay = function (day) {
        this.day = day;
        this.url = this.data.urlGetLaporanHargaDay + this.day;
        if (this.day == 99) {
            this.url = this.data.urlGetLaporanHarga;
    ...
    Maps.prototype.setKomoditas = function (id) {
        if (id == 'Komoditas') {
    ...
    Maps.prototype.formatDate = function (date) {
        var options = { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' };
        var d = new Date(date);
        return d.toLocaleDateString("en-US", options);
    };
    Maps.prototype.numberWithCommas = function (x) {
        var parts = x.toString().split(".");
        parts[0] = parts[0].replace(/\B(?=(\d{3})+(?!\d))/g, ".");
        return parts.join(".");
    };
        ...
        if (localStorage.getItem(this.type)) {
            ...
            if (this.selectKomoditas == 'Seluruh Komoditas') {
                ...
                if (this.type == 'infoHarga') {
                    this.dataMarkerFilter = this.dataMarker.filter(function (x) { return x.namaKomoditas == _this.selectKomoditas; });
                }
                else {
                    this.dataMarkerFilter = this.dataMarker.filter(function (x) { return x.nama_komoditas == _this.selectKomoditas; });
                }
            }
    ...
    Maps.prototype.getMarkerDataFunction = function () {
        var _this = this;
        this.authHttp.get(this.url)
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
            var length;
            if (JSON.stringify(_this.dataMarker)) {
                length = JSON.stringify(_this.dataMarker).length;
            }
            else {
                length = 0;
            }
            if (JSON.stringify(data.data) == '[]') {
                _this.clearMarker;
                _this.data.showMessageSuccess("Data Kosong");
            }
            if (length != JSON.stringify(data.data).length) {
                localStorage.setItem(_this.type, JSON.stringify(data.data));
                localStorage.setItem('id_token', data.token);
                _this.loadMarker();
                if (data.status == 200) {
                    _this.data.showMessageSuccess("Memperbaharui Data");
                }
                else {
                    _this.data.showMessageError(data.message);
                }
            }
            console.log(data);
        });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pieChart_component__ = __webpack_require__(769);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pieChart_service__ = __webpack_require__(733);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_easy_pie_chart_dist_jquery_easypiechart_js__ = __webpack_require__(718);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_style_loader_pieChart_scss__ = __webpack_require__(830);
...
var PieChart = (function () {
    ...
    PieChart.prototype._updatePieCharts = function () {
        ...
        jQuery('.pie-charts .chart').each(function (index, chart) {
            jQuery(chart).data('easyPieChart').update(getRandomArbitrary(25, 30));
        });
    };
    PieChart = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
...
module.exports = "<div class=\"feed-messages-container\" *ngIf=\"type == 'infoHarga'\">\n  <div class=\"feed-message\" *ngFor=\"let message of feed\" (click)=\"expandMessage(message)\">\n    <div class=\"text-block text-message\">\n      <div class=\"message-header\">\n        <span class=\"author\">{{ message.nama }} {{ message.surname}}</span>\n      </div>\n      <p style=\"color: #7fc623\">{{ message.namaKomoditas }} Rp. {{ numberWithCommas(message.harga)}}</p>\n      <div class=\"message-content line-clamp\" [ngClass]=\"{'line-clamp-2' : !message.expanded}\">\n        <span *ngIf=\"message.preview\">{{ message.header }} </span>{{ message.alamat }}\n      </div>\n      <div [ngClass]=\"{'hidden': !message.expanded}\" class=\"message-time\">\n        <div class=\"post-time\">\n          {{ formatDate(message.datePost) }}\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n<div class=\"feed-messages-container\" *ngIf=\"type == 'infoPanen'\">\n  <div class=\"feed-message\" *ngFor=\"let message of feed\" (click)=\"expandMessage(message)\">\n    <div class=\"text-block text-message\">\n      <div class=\"message-header\">\n        <span class=\"author\">{{ message.nama }} {{ message.surname}}</span>\n      </div>\n      <p style=\"color: #7fc623\">{{ message.nama_komoditas }} Rp. {{ message.harga }}</p>\n      <div class=\"message-content line-clamp\" [ngClass]=\"{'line-clamp-2' : !message.expanded}\">\n        <span *ngIf=\"message.preview\">{{ message.header }} </span>{{ message.alamat }}\n      </div>\n      <div [ngClass]=\"{'hidden': !message.expanded}\" class=\"message-time\">\n        <div class=\"post-time\">\n          {{ message.datePost }}\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n\n"
