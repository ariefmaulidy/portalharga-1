...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ngx_bootstrap_modal__ = __webpack_require__(706);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__materi_routing__ = __webpack_require__(773);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__materi_component__ = __webpack_require__(741);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_tables_tables_component__ = __webpack_require__(740);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__data_data_service__ = __webpack_require__(549);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MateriModule", function() { return MateriModule; });
...
var MateriModule = (function () {
    function MateriModule() {
    }
    MateriModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                __WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"],
                __WEBPACK_IMPORTED_MODULE_2__angular_forms__["FormsModule"],
                __WEBPACK_IMPORTED_MODULE_3__theme_nga_module__["a" /* NgaModule */],
                __WEBPACK_IMPORTED_MODULE_6__materi_routing__["a" /* routing */],
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_7__materi_component__["a" /* Materi */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_style_loader_tables_scss__ = __webpack_require__(834);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__data_data_service__ = __webpack_require__(549);
...
var Tables = (function () {
    function Tables(http, authHttp, data) {
        this.http = http;
    ...
    Tables.prototype.getMateriFunction = function () {
        var _this = this;
    ...
    Tables.prototype.updateMateriFunction = function (data) {
        var _this = this;
    ...
    Tables.prototype.addMateriFunction = function () {
        var _this = this;
        var creds = 'judul=' + this.judul + '&keterangan=' + this.keterangan;
        ...
        this.http.post(this.data.urlAddMateri, creds, { headers: headers })
            ...
            localStorage.setItem('id_token', data.token);
            _this.data.showMessage(data.message);
            _this.getMateriFunction();
            _this.loading = false;
            _this.add = false;
        });
    };
    Tables.prototype.deleteMateriFunction = function () {
        var _this = this;
        var creds = JSON.stringify({ materi_id: this.deleteId });
    ...
    Tables = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'tables',
            providers: [__WEBPACK_IMPORTED_MODULE_6__data_data_service__["a" /* DataService */]],
            encapsulation: __WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewEncapsulation"].None,
            template: __webpack_require__(817),
        }), 
        __metadata('design:paramtypes', [__WEBPACK_IMPORTED_MODULE_5__angular_http__["Http"], __WEBPACK_IMPORTED_MODULE_2_angular2_jwt__["AuthHttp"], __WEBPACK_IMPORTED_MODULE_6__data_data_service__["a" /* DataService */]])
    ], Tables);
    return Tables;
}());
// irmusyafa.dev
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(2);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Materi; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__materi_component__ = __webpack_require__(741);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_tables_tables_component__ = __webpack_require__(740);
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_1__materi_component__["a" /* Materi */],
        children: [
...
module.exports = "<div class=\"alert alert-info\">\n  Tabel materi untuk penyuluh. Anda dapat melakukan <b>penambahanan, pengubahan </b>dan <b>penghapusan</b> pada materi.\n</div>\n\n<div class=\"row\" style=\"margin-bottom: 10px\">\n  <div class=\"col-sm-12 col-xs-12 col-lg-12 col-md-12\">\n    <div [hidden]=\"add\" class=\"btn-group flex-dropdown pull-right\" dropdown>\n    \t<button type=\"button\" class=\"btn btn-primary\" (click)=\"showForm(true)\">Tambah Materi</button>\n    </div>\n    <div [hidden]=\"!add\" class=\"btn-group flex-dropdown pull-right\" dropdown>\n      <button type=\"button\" class=\"btn btn-danger\" (click)=\"showForm(false)\">Batal</button>\n    </div>\n  </div>\n</div>\n<div class=\"row\" [hidden]=\"add\">\n  <div class=\"col-md-12\">\n    <ng2-smart-table [settings]=\"settings\" [source]=\"source\" (deleteConfirm)=\"onDeleteConfirm($event)\" (editConfirm)=\"onSaveConfirm($event)\"></ng2-smart-table>\n  </div>\n</div>\n\n<ba-card [hidden]=\"!add\">\n  <div class=\"modal-header\">\n    <h4 class=\"modal-title\">Tambah Materi</h4>\n  </div>\n  <div class=\"modal-body\">\n  <div class=\"form-group\">\n    <label for=\"nama\">Judul Materi</label>\n    <input placeholder=\"Tuliskan judul materi. Misal: Perawatan tanaman\" [(ngModel)]=\"judul\" [disabled]=\"submit\" type=\"text\" class=\"form-control\">\n  </div>\n\n  <div class=\"row\">\n    <div class=\"col col-md-6\">\n      <div class=\"form-group\">\n        <label for=\"satuan\">Keterangan Materi</label>\n        <textarea placeholder=\"Tuliskan keterangan materi\" [(ngModel)]=\"keterangan\" [disabled]=\"submit\" type=\"number\" min=\"0\" class=\"form-control\" id=\"harga\"></textarea>\n      </div>\n    </div>\n    <div class=\"col col-md-6\">\n      <div class=\"form-group\">\n        <label for=\"harga\">Unggah Fail</label>\n        <input [(ngModel)]=\"file\" [disabled]=\"submit\" type=\"file\" accept=\"application/pdf,application/msword, application/vnd.ms-powerpoint\" class=\"form-control\">\n      </div>\n    </div>\n  </div>\n  </div>\n  <div class=\"modal-footer\">\n    <button data-dismiss=\"modal\" [disabled]=\"!judul || !keterangan\" (click)=\"onSubmitForm()\" type=\"button\" class=\"btn btn-primary btn-lg\"><i class=\"fa fa-spinner fa-spin\" [hidden]=\"!loading\" aria-hidden=\"true\"></i> Tambah</button>\n  </div>\n</ba-card>\n\n<div bsModal #childModal=\"bs-modal\" id=\"delete\" class=\"modal fade\" role=\"dialog\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">      \n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" (click)=\"childModal.hide()\">&times;</button>\n        <h4 class=\"modal-title\">Hapus Komoditas</h4>\n      </div>\n      <div class=\"modal-body\">\n\t\t  <p>{{hapusText}}</p>\n      </div>\n      <div class=\"modal-footer\">\n        <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\" (click)=\"childModal.hide()\">Close</button>\n        <button type=\"button\" data-dismiss=\"modal\" (click)=\"deleteMateriFunction();childModal.hide()\" class=\"btn btn-danger\">Submit</button>\n      </div>\n    </div>\n  </div>\n</div>\n\n"
